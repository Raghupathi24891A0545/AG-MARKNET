...
const strings = {
  en: {
    ...
    // Home page
    hero_badge: '🛰️ Live GPS + Satellite Soil + Weather Data',
    hero_title_1: "Your Farm's",
    hero_title_2: 'AI Advisor',
    hero_title_3: 'Is Here',
    hero_subtitle: 'Smart crop recommendations using your GPS location, satellite soil data, and live weather forecasts.',
    ...
    feature_crop_rec_desc: 'Top 3 crops with suitability scores, sowing months, and profit estimates based on your farm conditions.',
    ...
    feature_doctor_desc: 'Upload a leaf photo for AI disease detection. Instant diagnosis with treatment recommendations.',
    ...
    feature_chatbot: 'AI Chatbot',
    feature_chatbot_desc: 'Ask farming questions in English or Telugu. Get instant, actionable advice.',
    ...
    analyzer_desc: 'AI-powered crop and fertilizer recommendations using live GPS, real soil data, and live weather',
  ...
  te: {
    ...
    // Home page
    hero_badge: '🛰️ లైవ్ GPS + ఉపగ్రహ నేల + వాతావరణ డేటా',
    hero_title_1: 'మీ పొలం',
    hero_title_2: 'AI సలహాదారు',
    hero_title_3: 'ఇక్కడ ఉంది',
    hero_subtitle: 'మీ GPS స్థానం, ఉపగ్రహ నేల డేటా మరియు ప్రత్యక్ష వాతావరణ అంచనాలను ఉపయోగించి తెలివైన పంట సిఫారసులు.',
    ...
    feature_chatbot: 'AI చాట్‌బాట్',
    feature_chatbot_desc: 'ఇంగ్లీష్ లేదా తెలుగులో వ్యవసాయ ప్రశ్నలు అడగండి.',
